...
set noswapfile
set nobackup
set undodir=/home/$USER/.config/nvim/undodir
set undofile
set incsearch
set hlsearch
set scrolloff=5
...
set statusline=%F\ %m\ %r\ [%p%%]\ [%{&filetype}]
hi StatusLine ctermfg=Black ctermbg=White term=bold
...
" Ativar dobramento baseado em sintaxe
set foldmethod=syntax
set foldlevel=4     " Começa com funções dobradas até nível 1
